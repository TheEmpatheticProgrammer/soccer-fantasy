const TRANSLATIONS = {
  en: {
    ...
    'leaderboard.ptsDeltaGained': '+{n} pts from last match',
    'leaderboard.ptsDeltaZero': 'No points from last match',
  ...
  es: {
    ...
    'leaderboard.ptsDeltaGained': '+{n} pts desde el último partido',
    'leaderboard.ptsDeltaZero': 'Sin puntos del último partido',
