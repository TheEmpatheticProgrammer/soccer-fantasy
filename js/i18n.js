const TRANSLATIONS = {
  en: {
    ...
    'leagues.browseHeading': 'Public leagues',
    ...
    'leagues.noPublic': 'No public leagues yet — be the first to create one!',
    'leagues.enter': 'Enter',
  ...
  es: {
    ...
    'leagues.browseHeading': 'Ligas públicas',
    ...
    'leagues.noPublic': 'No hay ligas públicas todavía — ¡sé el primero en crear una!',
