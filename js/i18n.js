const TRANSLATIONS = {
  en: {
    ...
    'leaderboard.exportHint': "Download every player's picks and per-match points as an Excel workbook.",
    ...
    'leaderboard.exportError': 'Export failed: {msg}',
    ...
    'profile.leaguesHeading': 'My leagues',
    'profile.leaguesLoading': 'Loading…',
    'profile.noLeagues': "You're not in any leagues yet.",
    'profile.currentLeague': 'Current',
    'profile.switchLeague': 'Switch',
    'profile.browseLeagues': 'Browse leagues',
    ...
    'predictions.importButton': 'Import Scores',
    ...
    'predictions.searchPlayer': 'Search player…',
    'predictions.searchClear': 'Clear',
    'predictions.searchNoMatches': 'No players match "{q}".',
    'predictions.pickCount': '{count} pick',
    'predictions.pickCountPlural': '{count} picks',
    ...
    'leaderboard.rankDeltaUp': 'Up {n}',
    'leaderboard.rankDeltaDown': 'Down {n}',
    'leaderboard.rankDeltaFlat': 'No change',
    'leaderboard.ptsDeltaGained': '+{n} pts',
    'leaderboard.ptsDeltaZero': 'No points',
    'leaderboard.lastMatch': 'Last Match',
    'leaderboard.lastMatchInfoTitle': 'Last Match points',
    'leaderboard.lastMatchInfoBody': 'Points you earned from the most recent finished match.',
    'leaderboard.rankMove': 'Last Rank',
    'leaderboard.rankMoveInfoTitle': 'Last rank change',
    'leaderboard.rankMoveInfoBody': 'How your overall position shifted after the most recent finished match (▲ moved up, ▼ moved down).',
    ...
    'playerModal.points': '{points} pts · {scored}/{total} scored',
    'playerModal.noPicks': 'No predictions submitted.',
    'playerModal.readOnlyHint': 'Read-only — viewing another player.',
  ...
  es: {
    ...
    'leaderboard.exportHint': 'Descarga los pronósticos y puntos por partido de todos como un libro de Excel.',
    ...
    'leaderboard.exportError': 'Error al exportar: {msg}',
    ...
    'profile.leaguesHeading': 'Mis ligas',
    'profile.leaguesLoading': 'Cargando…',
    'profile.noLeagues': 'Aún no estás en ninguna liga.',
    'profile.currentLeague': 'Actual',
    'profile.switchLeague': 'Cambiar',
    'profile.browseLeagues': 'Explorar ligas',
    ...
    'predictions.importButton': 'Importar Marcadores',
    ...
    'predictions.searchPlayer': 'Buscar jugador…',
    'predictions.searchClear': 'Borrar',
    'predictions.searchNoMatches': 'Ningún jugador coincide con "{q}".',
    'predictions.pickCount': '{count} pronóstico',
    'predictions.pickCountPlural': '{count} pronósticos',
    ...
    'leaderboard.rankDeltaUp': 'Subió {n}',
    'leaderboard.rankDeltaDown': 'Bajó {n}',
    'leaderboard.rankDeltaFlat': 'Sin cambios',
    'leaderboard.ptsDeltaGained': '+{n} pts',
    'leaderboard.ptsDeltaZero': 'Sin puntos',
    'leaderboard.lastMatch': 'Último partido',
    'leaderboard.lastMatchInfoTitle': 'Puntos del último partido',
    'leaderboard.lastMatchInfoBody': 'Puntos que ganaste en el último partido terminado.',
    'leaderboard.rankMove': 'Última Posición',
    'leaderboard.rankMoveInfoTitle': 'Último cambio de posición',
    'leaderboard.rankMoveInfoBody': 'Cómo cambió tu posición general después del último partido terminado (▲ subió, ▼ bajó).',
    ...
    'playerModal.points': '{points} pts · {scored}/{total} calificados',
    'playerModal.noPicks': 'Sin pronósticos enviados.',
    'playerModal.readOnlyHint': 'Solo lectura — viendo a otro jugador.',
